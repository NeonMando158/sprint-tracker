...
public class WebSocketTest implements WebSocket.OnTextMessage {
	...
	public void startWebServer() throws Exception {
		...
		servletHandler.addServletWithMapping(SprintTrackerWebSocketServlet.class, "/ws/*");
	...
	@Test
	public void with_a_new_card_should_receive_a_message() throws Exception {
		WebSocketClientFactory webSocketClientFactory = new WebSocketClientFactory();
		webSocketClientFactory.start();
		try {
			WebSocketClient webSocketClient = webSocketClientFactory.newWebSocketClient();
			webSocketClient.setProtocol("vrandesh");
	...
	public void onOpen(Connection connection) {
		...
		assertThat(connection.getProtocol()).isEqualTo("vrandesh");
	}
